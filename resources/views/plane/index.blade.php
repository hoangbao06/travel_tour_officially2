                        ...
                        <form method="post" action="{{ route('plane.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-content">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Tên Máy Bay" class="form-control" name="ten-maybay" id="tenMayBay">
                                    <div class="form-group">
                                        <span style="color: rgb(240, 12, 12);display: none" id="error-tenMayBay">Chưa Thêm Tên Máy Bay !</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <span style="color: rgb(240, 12, 12);display: none" id="error-gioiThieuMayBay">Chưa Điền Thêm Giới Thiệu !</span>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <select class="selectpicker" data-style="btn btn-danger btn-block" title="Hãng Máy Bay" data-size="7" name="hang-maybay" id="chonMayBay">
                                    ...
                                    <div class="form-group">
                                        <span style="color: rgb(240, 12, 12);display: none" id="error-chonMayBay">Chưa Chọn hãng Máy Bay !</span>
                                    </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <span style="color: rgb(240, 12, 12);display: none" id="error-AnhMayBay">Chưa Chọn Ảnh Máy Bay !</span>
                                </div>
                                <div class="form-group">
                                ...
                                <button onclick="return kiemTraMayBay();" type="submit" class="btn btn-fill btn-info">ADD</button>
                            </div>
                        </form>
                    </div>
                </div>
