                    ...
                    <form method="post" action="{{ route('hotel.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Tên Khách Sạn" class="form-control" name="ten-khachsan" id="tenKhachSan">
                            </div>
                            <div class="form-group">
                                <span style="color: rgb(240, 12, 12);display: none" id="error-tenKhachSan">Chưa Thêm Tên Khách Sạn !</span>
                            </div>
                            <fieldset>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <span style="color: rgb(240, 12, 12);display: none" id="error-MTkhachSan">Chưa Thêm Miêu Tả Khách Sạn !</span>
                                </div>
                            </fieldset>
                            <br>
                            <div class="row">
                            ...
                            <div class="form-group">
                                <span style="color: rgb(240, 12, 12);display: none" id="error-AnhKhachSan">Chưa Thêm Ảnh Khách Sạn !</span>
                            </div>
                            <br>
                            <button onclick="return kiemTraKhachSan();" type="submit" class="btn btn-fill btn-info">ADD</button>
                        </div>
                    </form>
                </div>
            </div>
