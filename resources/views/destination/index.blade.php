                    ...
                    <form method="post" action="{{ route('destination.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-content">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Tên Địa Điểm" class="form-control" name="ten-diadiem" id="tenDiaDiem">
                            </div>
                            <div class="form-group">
                                <span style="color: rgb(240, 12, 12);display: none" id="error-tenDiaDiem">Chưa Thêm Tên Địa Điểm !</span>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <span style="color: rgb(240, 12, 12);display: none" id="error-AnhDiaDiem">Chưa Thêm Ảnh Địa Điểm !</span>
                            </div>
                            <br>
                            <div>
                                <button onclick="return kiemTraDiaDiem();" type="submit" class="btn btn-fill btn-info">ADD</button>
                            </div>
